<footer>
		...
		<div class'col-lg-8 col-md-8 col-sm-8 col-xs-8'>
			<div class='row'>
				...
				<div class='about-text-container col-lg-4 col-md-4 col-sm-4 col-xs-4'>
					<span class='about-text'>Bienvenido al sitio oficial de El Hombre de La Mancha, Un Musical. Actualmente en el Teatro Maipo, ubicado en Esmeralda 443. Tel: 5352-8384. Podés adquirir tus entradas en <a class="web-maipo-footer" target="_blank" href="https://www.plateanet.com/Comprar/el-hombre-de-la-mancha---un-musical">Plateanet</a> o ingresando en <a class="web-maipo-footer" target="_blank" href="http://www.maipo.com.ar">www.maipo.com.ar</a></span>
				</div>
				<div class='col-lg-1 col-md-1 col-sm-1 col-xs-1'></div>
			</div>
		</div>
	...
	<div id='rights-reserved' class='row'>
		...
		<p class="siteBy">Site by</p>
			<div class="pragaLogo">
				<a href="http://www.pragagroup.com"><img src="img/pragaLogo.png"></a>
			</div>
	</div>
</footer>